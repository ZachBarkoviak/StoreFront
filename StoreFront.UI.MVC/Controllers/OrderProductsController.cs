...
namespace StoreFront.UI.MVC.Controllers
{
    public class OrderProductsController : Controller
    {
        ...
        public OrderProductsController(FrontierConsolidatedStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var frontierConsolidatedStoreContext = _context.OrderProducts.Include(o => o.Order).Include(o => o.Product);
        ...
        {
            ViewData["OrderId"] = new SelectList(_context.Orders, "OrderId", "ShipToName");
        ...
        public async Task<IActionResult> Create([Bind("OrderProductId,ProductId,OrderId,Quantity,ProductPrice")] OrderProduct orderProduct)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Orders, "OrderId", "ShipToName", orderProduct.OrderId);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FrontierConsolidatedStoreContext.OrderProducts'  is null.");
            }
            var orderProduct = await _context.OrderProducts.FindAsync(id);
            if (orderProduct != null)
            {
